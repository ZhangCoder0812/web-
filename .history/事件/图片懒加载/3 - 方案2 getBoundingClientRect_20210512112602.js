/* 
  ...
  getBoundingClientRect 获取当前盒子和浏览器的可视窗口交叉信息
...
let imageModule = (function() {
    ...
    const lazyImgsFunc = function() {
        lazyImageBoxs.forEach(imgBox => {
            ...
            let A = imgBox.getBoundingClientRect().botttom,
    ...
    return {
        ...
        async init() {
            ...
            window.addEventListener("scroll", utils.throttle(lazyImgsFunc, 500)); //这里可以做个节流处理
        },
    };
})();
imageModule.init();
