...
可以运行js的环境：
   - 浏览器 script标签引入
          有window 不支持commonJs规范 支持ES6module规范type='mudule'
   - webview  Hybrid混合App开发「H5页面嵌入到native app中」
          有window 不支持commonJs规范 支持ES6module规范type='mudule'
   - webpack  编译js 
          支持window 支持commonJs/ES6module规范
   - node 
          不支持window 支持global 支持commonJs规范 不支持ES6module规范
